...
class NotificationService:
    ...
    async def send_email(
        ...
        *,
        ...
        return await self.email_sender.send_email(to=[to], subject=subject, text=text, html=html)
    ...
    async def send_email_to_workspace(
        ...
        *,
        ...
        for email_batch in batches:
            await self.email_sender.send_email(to=email_batch, subject=subject, text=text, html=html)
