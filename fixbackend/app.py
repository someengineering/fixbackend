...
def dev_router(deps: FixDependencies) -> APIRouter:
    ...
    async def custom_ui(hash: str) -> Response:
        ...
        headers["Content-Security-Policy"] = (
            "default-src 'self' https://*.fix.security;"
            f" connect-src 'self' data: https://*.fix.security https://capture.trackjs.com;"
            f" script-src 'self' 'nonce-{nonce}' https://*.fix.security https://www.googletagmanager.com;"
            f" style-src 'self' 'nonce-{nonce}' https://*.fix.security;"
            " font-src 'self' data: https://*.fix.security;"
            " img-src 'self' data: https://*.fix.security https://usage.trackjs.com https://i.ytimg.com https://www.googletagmanager.com/;"
            " frame-src 'self' https://*.fix.security https://www.youtube-nocookie.com;"
