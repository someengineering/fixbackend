...
def upgrade() -> None:
    ...
    fk_name = "organization_invite_ibfk_2"
    fk_exists = any(fk["name"] == fk_name for fk in inspector.get_foreign_keys("organization_invite"))
    if fk_exists:
        op.drop_constraint(fk_name, "organization_invite", type_="foreignkey")
